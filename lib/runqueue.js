...
(function() {
  ...
  RunQueue = (function() {
    RunQueue.deps = {
      ...
      mysql: ['runqueue'],
      config: ['runqueue.topic_defaults{back_off,last_fail,priority,external_group,limit,alarm_cnt,warn_cnt,warn_delay,alarm_delay}', 'runqueue.external_groups[default/ANY{connections,requests}]', 'runqueue.topics.ANY{call,type,priority,run_at,external_group}', 'runqueue.settings[poll_interval_ms,jobs,read_depth]']
    };
    ...
    RunQueue.prototype.AddJob = function(ctx, details, job_id) {
      ...
      if (job_id === false) {
        ...
        for (i = 0, len = ref.length; i < len; i++) {
          nm = ref[i];
          if (!(nm in details)) {
            throw new this.E.MissingArg(nm);
          }
        }
      ...
      return Promise.resolve().bind(this).then(function() {
        ...
        if (e.errno === 1062 && e.sqlMessage.includes("ix_runqueue__unique_key")) {
