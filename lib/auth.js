...
(function() {
  ...
  Auth = (function() {
    function Auth(kit) {
      this.parseAuthorization = __bind(this.parseAuthorization, this);
    ...
    Auth.prototype.parseAuthorization = function(req, res, next) {
    ...
    Auth.prototype.validateCredentials = function(ctx, username, password) {
      ...
      return Q.resolve().then(function() {
        ...
        creds = db_rows[0];
        return _this.comparePassword(password, creds.pwd);
