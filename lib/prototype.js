...
(function() {
  ...
  PrototypeModule = (function() {
    ...
    PrototypeModule.prototype.S_Update = function(ctx, pre_loaded, resource) {
      var batch_ids, conn, f, fn, i, id, j, len, len1, new_values, nm, p, q_result, r, r0id, result, schema, use_doc, val;
      use_doc = {
        params: this.mod.datasets[resource],
        response: {
          success: 'bool'
    ...
    PrototypeModule.prototype.S_Delete = function(ctx, pre_loaded, resource) {
      var batch_ids, before, conn, f, fn, i, id, j, len, len1, p, q_result, r, r0id, use_doc;
      use_doc = {
        params: {},
        response: {
          success: 'bool'
