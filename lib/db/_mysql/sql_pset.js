...
SqlPSetItemChange = (function() {
  ...
  SqlPSetItemChange.prototype.GetMostRecentChange = function(ctx) {
    var f,
      _this = this;
    ...
    return Q.resolve().then(function() {
      var sql;
      sql = 'SELECT ' + (_this.schema.recent.join(',')) + ' FROM ' + _this.table + ' WHERE di= 0 ORDER BY id DESC LIMIT 1';
      return _this.db.sqlQuery(ctx, sql);
    }).then(function(db_result) {
      return db_result;
    });
  };
