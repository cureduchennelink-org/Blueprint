...
(function() {
  ...
  SqlPSetItem = (function() {
    ...
    SqlPSetItem.prototype.lock = function(ctx, id) {
      ...
      return Promise.resolve().bind(this).then(function() {
        var sql;
        sql = 'SELECT id FROM ' + this.table + ' WHERE id= ? AND di= 0 FOR UPDATE';
    ...
    SqlPSetItem.prototype.get_psid_xref = function(ctx, pset_id, xref) {
      ...
      return Promise.resolve().bind(this).then(function() {
        var sql;
        sql = 'SELECT ' + (this.schema.id_xref.join(',')) + ' FROM ' + this.table + ' WHERE pset_id= ? AND xref= ? AND di= 0';
    ...
    SqlPSetItem.prototype.get_by_psid = function(ctx, pset_id) {
      ...
      return Promise.resolve().bind(this).then(function() {
        var sql;
        sql = 'SELECT ' + (this.schema.get_psid.join(',')) + ' FROM ' + this.table + ' WHERE pset_id= ? AND di= 0';
    ...
    SqlPSetItem.prototype.delete_pset = function(ctx, pset_id) {
      ...
      return Promise.resolve().bind(this).then(function() {
        var sql;
        sql = 'DELETE FROM ' + this.table + ' WHERE pset_id= ?';
        return this.db.sqlQuery(ctx, sql, [pset_id]);
      }).then(function(db_rows) {
        return db_rows;
      });
  ...
  SqlPSetItemChange = (function() {
    ...
    SqlPSetItemChange.prototype.delete_items = function(ctx, item_ids) {
      ...
      return Promise.resolve().bind(this).then(function() {
        var sql;
        sql = 'DELETE FROM ' + this.table + ' WHERE pset_item_id IN (?)';
    ...
    SqlPSetItemChange.prototype.GetMostRecentForItem = function(ctx, pset_id, pset_item_id) {
      ...
      return Promise.resolve().bind(this).then(function() {
        var sql;
        sql = 'SELECT ' + (this.schema.recent.join(',')) + ' FROM ' + this.table + ' WHERE di= 0 AND pset_id= ? AND pset_item_id= ?' + ' ORDER BY id DESC LIMIT 1';
    ...
    SqlPSetItemChange.prototype.GetMostRecentChanges = function(ctx, limit) {
      ...
      return Promise.resolve().bind(this).then(function() {
        var sql;
        sql = 'SELECT ' + (this.schema.next.join(',')) + ' FROM ' + ' (SELECT * FROM ' + this.table + ' WHERE di= 0' + ' ORDER BY id DESC LIMIT ?) sub' + ' ORDER BY id ASC';
    ...
    SqlPSetItemChange.prototype.GetNext = function(ctx, from, limit) {
      ...
      return Promise.resolve().bind(this).then(function() {
        var sql;
        sql = 'SELECT ' + (this.schema.next.join(',')) + ' FROM ' + this.table + ' WHERE di= 0' + sql_from + ' ORDER BY count ' + sql_limit;
