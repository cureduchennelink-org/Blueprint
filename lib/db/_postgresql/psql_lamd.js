...
class PSqlLamd {
	...
	constructor(core, kit) {
		...
		this.schema = {
			q_lastbad100:     {statusCode: 1, date: 1, route: 1, verb: 1, err: 3, req_uuid: 1},
			q_last100:        {statusCode: 1, date: 1, route: 1, verb: 1, err: 3, req_uuid: 1},
			q_deadlocks:      {statusCode: 1, date: 1, route: 1, verb: 1, err: 3, req_uuid: 1, start: 1, },
