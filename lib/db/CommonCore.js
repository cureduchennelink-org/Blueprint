...
(function() {
  ...
  CommonCore = (function() {
    ...
    function CommonCore(kit, pool_opts) {
    ...
    CommonCore.prototype.StartTransaction = function(ctx) {
      var f;
    ...
    CommonCore.prototype.method_factory = function(sql_mod, name) {
        ...
        create = (function(_this) {
          return function(ctx, new_values, re_read) {
            ...
            return Promise.resolve().bind(_this).then(function() {
              ...
              sql = "INSERT INTO " + table + " (" + (cols.join(',')) + ") VALUES (" + (qs.join(',')) + ") RETURNING id";
              return sqlQuery(ctx, sql, arg);
            }).then(function(db_result) {
              var sql;
              result = db_result;
