...
(function() {
  var E, Q, Wrapper, config, odb, request_count, request_count_high, sdb, _log,
  ...
  Wrapper = (function() {
    ...
    Wrapper.prototype["default"] = function(req, res, next, endpoint) {
      var ctx, f, p, pre_loaded, result, route_logic, _ref, _ref1, _ref2, _ref3;
      ...
      if (endpoint.auth_required || endpoint.permit) {
        if (((_ref3 = config.perf) != null ? _ref3.test_user_override : void 0) === true && typeof p.mock_id === "string") {
      ...
      return Q.resolve().then((function(_this) {
        ...
        return function() {
          var func, nm, q_result, _fn, _ref4;
          q_result = Q.resolve(true);
          _ref4 = endpoint.pre_load;
        ...
        return function(err) {
          var end, _ref4;
          delete ctx.pool;
          if ((_ref4 = err.statusCode) !== 400 && _ref4 !== 403) {
            req.log.error(f, '.fail', err, err.stack);
          } else {
