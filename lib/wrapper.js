...
(function() {
  ...
  Wrapper = (function() {
    ...
    Wrapper.prototype["default"] = function(req, res, next, endpoint) {
      var ctx, f, p, pre_loaded, ref, ref1, ref2, result, route_logic;
      ...
      return Q.resolve().then((function(_this) {
        ...
        return function() {
          var fn, func, nm, q_result, ref3;
          q_result = Q.resolve(true);
          ref3 = endpoint.pre_load;
          fn = function(nm, func) {
        ...
        return function(err) {
          var end, ref3;
          delete ctx.pool;
          if ((ref3 = err.statusCode) !== 400 && ref3 !== 403) {
            req.log.error(f, '.fail', err, err.stack);
          } else {
