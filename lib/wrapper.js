  ...
  Wrapper = (function() {
    ...
    Wrapper.prototype.add = function(mod) {
      ...
      for (func in _ref) {
        ...
        _results.push(this.router.add_route(endpoint.verb, endpoint.route, wrap));
      }
      return _results;
    };
    ...
    Wrapper.prototype.auth = function(req, res, next, caller) {
      var conn, ctx, f, p, pre_loaded, route_logic, send_result, supported_grant_type, _ref, _ref1, _ref2;
      f = "Wrapper:auth";
    ...
    Wrapper.prototype.read = function(req, res, next, caller) {
      var ctx, f, p, pre_loaded, route_logic, _ref, _ref1;
