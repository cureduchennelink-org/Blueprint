...
const RunQueueMongoDbSchema= function() {

	const schema= new mongoose.Schema({
		//_id: type: String
		di: {           type: Number, required: true, enum: [0, 1, 2], default: 0
	}, // 0 none, 1 disabled, 2 purge
		...
		in_process: {   type: Number, required: true, enum: [0, 1], default: 0
