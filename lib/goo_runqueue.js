...
(function() {
  var Promise, RunQueueMongoDbPersistence, RunQueueMongoDbSchema, _, logRequest, logResponse, mongoose, showme;
  ...
  RunQueueMongoDbPersistence = (function() {
    ...
    RunQueueMongoDbPersistence.prototype.GetNextJobs = function(ctx, maxRows, maxRetries) {
      var conditions, date, f, oneSMore;
      if (maxRetries == null) {
        maxRetries = 8;
      }
      f = "RunQueueMongoDbPersistence::GetNextJobs: ";
      date = new Date();
      oneSMore = new Date(date - 1000);
      conditions = {
        in_process: 0,
        run_at: {
          $lte: oneSMore
