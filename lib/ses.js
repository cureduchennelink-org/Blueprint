...
(function() {
  ...
  SES = (function() {
    function SES(kit) {
      ...
      this.log.info('Initializing SES...');
      AWS.config.update({
    ...
    SES.prototype._composeMsgFrom = function(spec, data) {
      var f, send_to, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
      f = 'SES._composeMsgFrom:';
      this.log.debug(f, spec, data);
      send_to = this.config.debug_email !== false ? this.config.debug_email : data.Recipient[0];
      return {
        Destination: {
          ToAddresses: [send_to],
