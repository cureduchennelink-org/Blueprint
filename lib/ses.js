...
(function() {
  var AWS, Promise, SES, _, email_content, email_content_text, eml_attributes, f, htmlToText, message, recipient, ref, ref1, ref2, ref3, ref4, ref5, send_to, spec;
  ...
  this.sendEmailAsPromised(message({
    _composeMsgFrom: function(spec, data) {}
  }));
  ...
  email_content = this.template.render(eml_attributes.model, eml_attributes.tmpl, eml_attributes.page, data);
