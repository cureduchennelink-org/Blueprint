...
(function() {
  var Linkedin, Promise, querystring, request,
  ...
  Linkedin = (function() {
    ...
    Linkedin.prototype.get_access_token = function(ctx, authorization_code) {
    ...
    Linkedin.prototype.get_linkedin_user = function(ctx, accessToken) {
      var f, opts;
    ...
    Linkedin.prototype.get_linkedin_user_email = function(ctx, accessToken) {
      var f, opts;
    ...
    Linkedin.prototype.handleErrors = function(ctx, e) {
      var f;
