  ...
  Server = (function() {
    ...
    Server.prototype.add_restify_handlers = function() {
      ...
      for (i = 0, len = ref.length; i < len; i++) {
        ...
        results.push(this.server.use(restify[handler](this.config.restify[handler])));
      }
      return results;
    };
    ...
    Server.prototype.add_static_server = function() {
      ...
      return this.server.get(path, restify.serveStatic(this.config.api.static_file_server));
    };
