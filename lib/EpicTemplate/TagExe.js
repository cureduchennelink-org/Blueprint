...
(function() {
  ...
  TagExe = (function() {
    ...
    TagExe.prototype.formatFromSpec = function(val, spec, custom_spec) {
      var f, left, new_stuff, right, str, _base, _ref;
      f = 'TagExe.formatFromSpec';
      switch (spec) {
        case '':
          this.Epic.log2(f, 'typeof', typeof window.EpicMvc.custom_filter);
          new_stuff = typeof (_base = window.EpicMvc).custom_filter === "function" ? _base.custom_filter(val, custom_spec) : void 0;
    ...
    TagExe.prototype.loadFistDef = function(flist_nm) {
      var _base;
      return (_base = this.fist_objects)[flist_nm] != null ? (_base = this.fist_objects)[flist_nm] : _base[flist_nm] = this.Epic.getFistInstance(flist_nm);
    };
