...
(function() {
  ...
  Push = (function() {
    ...
    Push.prototype.GetPushSet = function(clear_pset, nm) {
      ...
      return Q.resolve().then((function(_this) {
        return function() {
          return sdb.pset.read_or_insert(_this.ctx, nm);
        };
      })(this)).then((function(_this) {
        return function(pset_rec) {
          ...
          return _this.S_CleanPushSet(_this.ctx, pset_id);
        };
      })(this)).then((function(_this) {
        return function(clean_result) {
  ...
  PushSet = (function() {
    ...
    PushSet.prototype.GetPushHandle = function(ctx, xref) {
      ...
      return Q.resolve().then((function(_this) {
        ...
        return function(db_rows) {
          if (!db_rows.length) {
            throw new E.ServerError("PUSHSET:GET_HANDLE:NO_LATEST_CHANGE", _this.pset.id + "/" + item_rec.id + "/?");
          }
