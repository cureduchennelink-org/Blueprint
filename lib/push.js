...
Push = (function() {
  ...
  Push.prototype.S_Poll = function() {
    ...
    return Q.resolve().then(function() {
      ...
      var cb, sorted_changes, _i, _len, _ref;
      if (db_rows.length) {
      ...
      sorted_changes = _this.S_SortChanges(db_rows);
  ...
  Push.prototype.S_SortChanges = function(raw_changes) {
    var data, f, partial_handle, rec, _i, _len, _ref;
    ...
    for (_i = 0, _len = raw_changes.length; _i < _len; _i++) {
      ...
      if ((_ref = data[partial_handle]) == null) {
        data[partial_handle] = [];
      }
