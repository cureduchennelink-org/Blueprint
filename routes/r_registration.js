...
(function() {
  ...
  Registration = (function() {
    function Registration(kit) {
      this._register_signup = __bind(this._register_signup, this);
      this._read_signup = __bind(this._read_signup, this);
      this._signup = __bind(this._signup, this);
    ...
    Registration.prototype._signup = function(ctx, pre_loaded) {
      ...
      return Q.resolve().then(function() {
        return sdb.auth.get_by_cred_name(ctx, p.eml);
