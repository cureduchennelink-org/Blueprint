...
(function() {
  var AuthRoute, E, ITERATIONS, KEY_LENGTH, Q, SALT_SIZE, crypto, moment, sdb,
  ...
  AuthRoute = (function() {
    ...
    AuthRoute.prototype._authenticate = function(ctx, pre_loaded) {
      ...
      return Q.resolve().then(function() {
        ...
        return sdb.token.update_active_token(ctx, result.auth_ident_id, p.client_id, exp, new_token, current_token);
