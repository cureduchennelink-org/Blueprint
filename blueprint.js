...
(function() {
  var AuthParser, AuthRoute, Db, PreLoader, TokenMgr, User, Workout, Wrapper, auth, authParser, bunyan, config, db, log, ping, pre_loader, restify, server, tokenMgr, user, workout, wrapper;
