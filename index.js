...
(function() {
  exports.start = function() {
    var Error, Kit, Logger, M, Q, config, handler, kit, log, mod, nm, opts, path, q_result, restify, route, routePath, server, service, servicePath, _, _fn, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
    M = require('moment');
    Q = require('q');
