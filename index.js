...
(function() {
  exports.start = function(include_server, services_enabled, routes_enabled, mysql_enabled, mysql_mods_enabled, mongo_enabled, more_config, more_kit) {
    var ErrorMore, Kit, Logger, M, Promise, Server, _, config, fn, i, j, kit, len, len1, log, mod, nm, opts, path, q_result, ref, ref1, ref2, ref3, route, routePath, server, service, servicePath;
    if (more_config == null) {
      more_config = {};
    }
    if (more_kit == null) {
