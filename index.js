...
(function() {
  exports.start = function(include_server, services_enabled, routes_enabled, mysql_enabled, mysql_mods_enabled, mongo_enabled) {
    var ErrorMore, Kit, Logger, M, Q, Server, config, fn, i, j, kit, len, len1, log, mod, nm, opts, path, q_result, ref, ref1, ref2, ref3, route, routePath, server, service, servicePath;
    server = false;
    M = require('moment');
    Q = require('q');
    path = require('path');
