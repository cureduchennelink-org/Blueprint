...
var CHECK_birthDate, CHECK_phoneAny, D2H_html5date, bdvel_watcher, custom_filter, filter_chars, filter_chars_pluggin;

bdvel_watcher = function() {
  var $dur;
  $dur = "medium";
  $(".dbg-toolbar").css({
    "right": 0,
