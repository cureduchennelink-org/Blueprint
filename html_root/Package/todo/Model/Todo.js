...
(function() {
  ...
  Todo = (function(_super) {
    ...
    function Todo(view_nm, opts) {
      ...
      Todo.__super__.constructor.call(this, view_nm, opts, ss);
    ...
    Todo.prototype.action = function(ctx, act, p) {
      ...
      switch (act) {
        ...
        case "save_todo":
          ...
          title = p.val;
          if (id != null) {
            if (title === this.c_todo.Item_idx[id].title) {
              return;
            }
            data = {
              title: title
            };
            return (this.rest.D_NoAuthPost("Prototype/Todo/Item/" + id + "/update", f, data)).then(function(results) {
        ...
        case "mark_all":
          ...
          break;
        default:
          return Todo.__super__.action.call(this, ctx, act, p);
      }
    };
