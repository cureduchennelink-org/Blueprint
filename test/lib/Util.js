...
(function() {
  var Db, Promise, _, config, http, mysql,
  ...
  Db = (function() {
    ...
    Db.prototype.SqlQuery = function(sql, args) {
      ...
      return (Promise.fromNode(this.conn, 'query', sql, args)).then(function(rows_n_cols) {
        return rows_n_cols[0];
      });
    };

    Db.prototype.GetOne = function(table, id) {
      return Promise.resolve().bind(this).then((function(_this) {
        return function() {
          var sql;
