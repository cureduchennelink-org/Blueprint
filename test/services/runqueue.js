...
(function() {
  var Mdb, Promise, _, _log, chai, clean_db_jobs, clean_poll_result, config, is_it, it_is, moment, mydb, server, showme;
  ...
  showme = function(obj) {
    ...
    return console.log('SHOWME:' + typeof obj, {
      ...
      name: (ref = (ref1 = obj.constructor) != null ? ref1.name : void 0) != null ? ref : 'no-name'
    });
  };
  ...
  describe('RunQueue: ', function() {
    ...
    before(function() {
      return Promise.resolve().then(function() {
        var ref;
        return Mdb.Instance((ref = process.env.npm_config_mongodb_uri) != null ? ref : 'NEED-ENV-npm_config_mongodb_uri');
    ...
    describe('_Poll/init: ', function() {
      before(function() {
        ...
        return cleanup().then(function() {
          ...
          config_overrides = {
            runqueue: {
              mongodb_uri: (ref = process.env.npm_config_mongodb_uri) != null ? ref : "YOU-NEED-TO-SET-ENV-npm_config_mongodb_uri"
            },
            service_modules: {
              GenericService: {
          ...
          console.log(x = (function() {
            ...
            for (i = 0, len = result.length; i < len; i++) {
              ...
              results.push((function() {
                ...
                for (nm in rec) {
                  obj = rec[nm];
                  results1.push([nm, (ref = (ref1 = obj.length) != null ? ref1 : (ref2 = obj.constructor) != null ? ref2.name : void 0) != null ? ref : typeof obj]);
                }
                return results1;
              })());
            }
