...
(function() {
  var Mdb, Promise, _, _log, chai, clean_db_jobs, clean_poll_result, config, is_it, it_is, moment, mongo_url, mydb, ref, server, showme;
  ...
  mongo_url = (ref = process.env.npm_config_mongodb_uri) != null ? ref : "mongodb://localhost/test";

  showme = function(obj) {
    var nm, ref1, ref2, val;
    return console.log('SHOWME:' + typeof obj, {
      ...
      name: (ref1 = (ref2 = obj.constructor) != null ? ref2.name : void 0) != null ? ref1 : 'no-name'
    });
  };
        ...
        results.push((function() {
          ...
          for (j = 0, len1 = ref1.length; j < len1; j++) {
            ...
            if (debug) {
              _log(f + 'OBJ?', {
                o: line[obj_key],
                t: typeof ((ref2 = line[obj_key]) != null ? ref2.affectedRows : void 0)
              });
            }
    ...
    describe('AddJob topic_success HAPPY path: ', function() {
      ...
      it('Just topic and json', function() {
        ...
        return Promise.resolve().then(function() {
          ...
          (dbcr != null ? (ref1 = dbcr.constructor) != null ? ref1.name : void 0 : void 0).should.equal("Date");
      ...
      it('Topic has retries', function() {
        ...
        return Promise.resolve().then(function() {
          ...
          fail_promises = (function() {
            var i, ref1, results;
            results = [];
            for (i = 1, ref1 = expected_retries; 1 <= ref1 ? i <= ref1 : i >= ref1; 1 <= ref1 ? i++ : i--) {
