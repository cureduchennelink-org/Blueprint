...
(function() {
  var Auth, E, Kit, Mock, TokenMgr, Util, chai, config, encryptedPassword, kit, mockDb, moment, pChai, req, _, _log;
  ...
  describe('Auth Service', function() {
    ...
    it('should Encrypt passwords using variable salt', function() {
      ...
      return (auth.EncryptPassword('password')).then(function(encryption) {
        var _ref;
        _ref = encryption.split('.'), salt1 = _ref[0], hash1 = _ref[1];
        return auth.EncryptPassword('password');
      }).then(function(encryption) {
        var _ref;
        _ref = encryption.split('.'), salt2 = _ref[0], hash2 = _ref[1];
