...
(function() {
  var Db, Kit, Logger, Util, bpDir, chai, config, db, fs, instMap, kit, mongoose, _;
  ...
  describe('DAO', function() {
    if (config.db.mysql.enable) {
      describe('MySql', function() {
        ...
        return it('should expose a new instance of each module defined in the config', function() {
          var module, nm, _ref, _results;
          _ref = config.db.mysql.modules;
          _results = [];
          for (nm in _ref) {
            module = _ref[nm];
            db.mysql.should.have.property(nm);
            _results.push(db.mysql[nm].should.be.an["instanceof"](instMap[nm].inst));
          }
          return _results;
        });
      });
    ...
    if (config.db.mongo.enable) {
      return describe('MongoDB', function() {
        ...
        return it('should expose a new instance of each module defined in the config', function() {
          var module, nm, _ref, _results;
          _ref = config.db.mongo.modules;
          _results = [];
          for (nm in _ref) {
            module = _ref[nm];
            db.mongo.should.have.property(nm);
            _results.push(db.mongo[nm].should.be.an["instanceof"](mongoose.Model));
          }
          return _results;
        });
      });
