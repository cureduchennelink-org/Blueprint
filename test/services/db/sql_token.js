  ...
  describe("Sql Token Module", function() {
    ...
    before(function() {
      ...
      valid_vals = {
        ...
        exp: moment()
          .add(config.auth.refreshTokenExpiration, "seconds")
          .toDate()
      };
      return Util.db
        .InsertOne("ident_tokens", valid_vals)
      ...
      return core
        ...
        .then(function(c) {
          ...
          new_values = {
            ...
            client: "TEST_FRAMEWORK",
            exp: moment()
              .add("seconds", config.refreshTokenExpiration)
              .toDate()
          };
        ...
        .then(function(new_rec) {
          ...
          return Util.db.GetByKey(ctx, "ident_tokens", "token", [
            new_values.token
          ]);
        })
