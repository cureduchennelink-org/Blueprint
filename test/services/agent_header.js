  ...
  describe("AgentHeader:service:", function() {
    ...
    before(function() {
      return Promise.resolve()
        ...
        .then(function(c) {
          base_ctx.conn = c;
          return sdb.core.sqlQuery(
            base_ctx,
            "INSERT INTO agent_header (agent_header, agent_header_md5) VALUES (?, MD5(?))",
        ...
        .then(function(db_results) {
          ...
          return sdb.core.sqlQuery(
            base_ctx,
            "SELECT id FROM agent_header ORDER BY id desc LIMIT 1"
          );
        })
    ...
    return it("handles simultaineous updates", function() {
      ...
      return Promise.resolve()
        .then(function() {
          ...
          for (i = j = 1; j <= 20; i = ++j) {
            p.push(
              (s = module.xlate(agent_string_4 + " #" + next_expected_id))
            );
