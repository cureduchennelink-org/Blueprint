...
module.exports = {
  ...
  throttling: {
    // Wrapper uses this for rejecting requests when we are this far behind
  ...
  route_modules: {
    ...
    Workout: {
      class: 'Workout',
      file: 'node_modules/blueprint/routes/r_workout',
    },
  },
  service_modules: {
    web_config: {
    ...
    template: {
      ...
      instConfig: { view_path: vp_email },
    },
    template_use: {
      class: 'EpicTemplate',
      file: 'node_modules/blueprint/lib/EpicTemplate',
      instConfig: { view_path: vp_use },
    },
    tokenMgr: {
      class: 'TokenMgr',
    ...
    s3: { class: 'S3', file: 'node_modules/blueprint/lib/s3' },
  },
  ...
  runqueue: {
    ...
    topic_defaults: {
      back_off: 'standard',
      last_fail: false, // No special handling
      priority: 1000,
      group_ref: 'NONE',
      limit: rq_max, // no reasonable limit
      alarm_cnt: 8,
      warn_cnt: 3,
      warn_delay: [3, 'm'],
      alarm_delay: [10, 'm'],
  ...
  db: {
    ...
    psql: {
      ...
      modules: {
        token: {
          class: 'SqlToken',
          file: 'node_modules/blueprint/lib/db/_postgresql/sql_token',
        },
        auth: {
          class: 'SqlAuth',
          file: 'node_modules/blueprint/lib/db/_postgresql/sql_auth',
        },
        runqueue: {
          class: 'PSqlRunQueue',
          file: 'node_modules/blueprint/lib/db/_postgresql/psql_runqueue',
        },
      },
    },
    mysql: {
	...
	var	opts= {
		rest: {
          ...
          typeof api_host !== 'undefined' && api_host !== null
			...
			, port: '${
        process.env.npm_config_elb_port != null
          ? process.env.npm_config_elb_port
          : 80
      }'
			, prefix: 'api'
			, version: 'v1'
