...
module.exports = {
	...
	route_modules: {
		Health: {
			class: 'HealthCheck', file: 'node_modules/blueprint/routes/r_health'
		},
		Auth: {
			class: 'AuthRoute', file: 'node_modules/blueprint/routes/r_auth'
		},
		Poll: {
			class: 'LongPoll', file: 'node_modules/blueprint/routes/r_poll'
		},
		Registration: {
			class: 'Registration', file: 'node_modules/blueprint/routes/r_registration'
		},
		User: {
			class: 'User', file: 'node_modules/blueprint/routes/r_user'
		},
		Workout: {
			class: 'Workout', file: 'node_modules/blueprint/routes/r_workout'
		}
	},
	service_modules: {
		PollManager: {
		...
		PushManager: {
			"class": 'PushManager', file: 'node_modules/blueprint/lib/PushManager'
		},
		web_config: {
			class: 'WebConfig', file: 'node_modules/blueprint/lib/web_config'
		},
		template: {
			class: 'EpicTemplate', file: 'node_modules/blueprint/lib/EpicTemplate', instConfig: { view_path: vp_email }
		},
		template_use: {
			class: 'EpicTemplate', file: 'node_modules/blueprint/lib/EpicTemplate', instConfig: { view_path: vp_use }
		},
		tokenMgr: {
			class: 'TokenMgr', file: 'node_modules/blueprint/lib/token_manager'
		},
		event: {
			class: 'Event', file: 'node_modules/blueprint/lib/event'
		},
		db: {
			class: 'Db', file: 'node_modules/blueprint/lib/db'
		},
		util: {
			class: 'Util', file: 'node_modules/blueprint/lib/util'
		},
		auth: {
			class: 'Auth', file: 'node_modules/blueprint/lib/auth'
		},
		router: {
			class: 'Router', file: 'node_modules/blueprint/lib/router'
		},
		wrapper: {
			class: 'Wrapper', file: 'node_modules/blueprint/lib/wrapper'
		},
		prototype: {
			class: 'Prototype', file: 'node_modules/blueprint/lib/prototype'
		},
		ses: {
			class: 'SES', file: 'node_modules/blueprint/lib/ses'
		},
		tripMgr: {
			class: 'TripManager', file: 'node_modules/blueprint/lib/trip_manager'
		},
		lamd: {
			class: 'PLamd', file: 'node_modules/blueprint/lib/PLamd'
		},
		AgentHeader: {
			class: 'AgentHeader', file: 'node_modules/blueprint/lib/agent_header'
		},
		RunQueue: {
			class: 'RunQueue', file: 'node_modules/blueprint/lib/runqueue'
		},
		elb_redirect: {
			class: 'ELBRedirect', file: 'node_modules/blueprint/lib/elb_redirect'
	...
	runqueue: {
		...
		external_groups: {
			default: {
				connections: rq_max, requests: [rq_max, rq_max, 'm']
	...
	db: {
		...
		psql: {
			...
			modules: {
				push_item: { "class": 'PSqlPushItem', file: 'node_modules/blueprint/lib/db/_postgresql/psql_push_item' },
		...
		mysql: {
			...
			modules: {
				auth: {
					class: 'SqlAuth', file: 'node_modules/blueprint/lib/db/_mysql/sql_auth'
				},
				user: {
					class: 'SqlUser', file: 'node_modules/blueprint/lib/db/_mysql/sql_user'
				},
				token: {
					class: 'SqlToken', file: 'node_modules/blueprint/lib/db/_mysql/sql_token'
				},
				trip: {
					class: 'SqlTrip', file: 'node_modules/blueprint/lib/db/_mysql/sql_trip'
				},
				pset: {
					class: 'SqlPSet', file: 'node_modules/blueprint/lib/db/_mysql/sql_pset'
				},
				pset_item: {
					class: 'SqlPSetItem', file: 'node_modules/blueprint/lib/db/_mysql/sql_pset'
				},
				pset_item_change: {
					class: 'SqlPSetItemChange', file: 'node_modules/blueprint/lib/db/_mysql/sql_pset'
				},
				agent_header: {
					class: 'SqlAgentHeader', file: 'node_modules/blueprint/lib/db/_mysql/sql_agent_header'
				},
				runqueue: {
